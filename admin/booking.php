		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<!--<li class="colorlib-active"><a href="booking.php">View booking</a></li>
         ...
         <div id="colorlib-main">
			<section>
              ...
              <div class="back">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span><span>view booking</span></p>
