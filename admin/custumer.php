...
.hompg i{ font-size:30px; margin:40px;}
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li class="colorlib-active"><a href="custumer.php">View custumer</a></li>
         ...
         <div id="colorlib-main">
			<section>
              ...
              <div class="back">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span><span>view custumer</span></p>
                
               
					
	         <!-- <div class="col-md-12">
                             <div class="back">
							<span class="hom"> <a href="index.html">Home</a></span> 
          ...
          <a href="product.html"><span><i class="fa-brands fa-opencart"></i></span><h6>add product</h6></a>
         <a href="custumer.html"><span><i class="fa fa-eye" aria-hidden="true"></i></span><h6>view custumers</h6></a>
        <a href=""><span><i class="fa fa-list-ol" aria-hidden="true"></i></span><h6>view booking</h6></a>
        <a href=""><span><i class="fa fa-user-circle" aria-hidden="true"></i></span><h6>logout</h6></a>
...
<?php
	...
	<th style='background-color:RED'> <font color='WHITE'> number </th> 
	<th style='background-color:RED'><font color='WHITE'>email</th> 
	<th style='background-color:RED'> <font color='WHITE'> pincode </th> ";
   ...
   <td style='background-color:white'><font color='Black'> $result1[number] </td>
   <td style='background-color:white'><font color='Black'> $result1[email] </td>
   <td style='background-color:white'><font color='Black'> $result1[pincode] </td>";
