        	...
        	<div class="row pt-4 pb-5">
            	...
            	<div class="col-md-6 col-12 col-sm-6 col-lg-2 col-xl-2 pt-3">
                	<div class="text-left">
                        ...
                        <ul class="links">
                        	<li><a href="catagory.php">Vegitarian</a></li>
                            <li><a href="catagory.php">Non Veg</a></li>
                            <li><a href="catagory.php">Fruits</a></li>
                            <li><a href="catagory.php">Nuts</a></li>
                            <li><a href="catagory.php">protien Rich</a></li>
                            <li><a href="catagory.php">Carb Foods</a></li>
                            <li><a href="catagory.php">Snacks</a></li>
                            <li><a href="catagory.php">Cakes</a></li>
                            <li><a href="catagory.php">Shakes</a></li>
                            <li><a href="catagory.php">Trending</a></li>
                            <li><a href="catagory.php">Pizza</a></li>
                        </ul>
                    </div>
                </div>
